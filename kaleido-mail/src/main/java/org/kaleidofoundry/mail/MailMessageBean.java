...
import static org.kaleidofoundry.mail.MailConstants.LOGGER;
...
import org.kaleidofoundry.core.io.MimeTypesDefaultService;
import org.kaleidofoundry.core.io.MimeTypesFactory;

/**
 * Implémentation MailMessageBean
 * 
...
public class MailMessageBean implements MailMessage {
   ...
   public void addAttachment(final String attachName, final String filename) throws FileNotFoundException, IOException {
	...
	MimeTypesDefaultService mimesSrv = null;
	String fileExt = null;

	mimesSrv = MimeTypesFactory.getService();
   ...
   public void addAttachment(final String attachName, final URL fileURL) throws IOException {
	...
	if (fileExt == null) { throw new IOException("Filename " + fileURL.toExternalForm()
		+ " have an unknown mime type"); }
