...
CREATE TABLE CONFIGURATION (ID BIGINT NOT NULL, LOADED SMALLINT DEFAULT 0, UPDATEALLOWED SMALLINT DEFAULT 0, STORAGEALLOWED SMALLINT DEFAULT 0, DESCRIPTION VARCHAR(255), NAME VARCHAR(255) UNIQUE, URI VARCHAR(255) UNIQUE, VERSION INTEGER, LABELS VARCHAR(255), PRIMARY KEY (ID))
