...
CREATE TABLE CONFIGURATION (ID BIGINT NOT NULL, DESCRIPTION VARCHAR(255), NAME VARCHAR(255) UNIQUE, URI VARCHAR(255) UNIQUE, VERSION INTEGER, LABELS VARCHAR(255), PRIMARY KEY (ID))
