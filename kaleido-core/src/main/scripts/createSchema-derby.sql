...
CREATE TABLE CONFIGURATION (ID BIGINT NOT NULL, DESCRIPTION VARCHAR(255), NAME VARCHAR(255) UNIQUE, URI VARCHAR(255) UNIQUE, VERSION INTEGER, PRIMARY KEY (ID))
...
CREATE TABLE FILESTORE (URI VARCHAR(255) NOT NULL, CONTENT BLOB(2147483647), CREATIONDATE TIMESTAMP NOT NULL, CONTENTSIZE INTEGER, UPDATEDDATE TIMESTAMP, NAME VARCHAR(255), PATH VARCHAR(255), VERSION INTEGER, PRIMARY KEY (URI))
CREATE TABLE CONFIGURATION_PROPERTY (ID BIGINT NOT NULL, DESCRIPTION VARCHAR(255), NAME VARCHAR(255), VALUE VARCHAR(255), TYPE VARCHAR(255), VERSION INTEGER, PRIMARY KEY (ID))
...
CREATE TABLE I18N_GROUP (CODE VARCHAR(255) NOT NULL, VERSION INTEGER, PARENT_CODE VARCHAR(255), DESCRIPTION_ID BIGINT, PRIMARY KEY (CODE))
