 ...
 */
public class JcsCacheTest extends AbstractCacheTest {

   private CacheManager cacheManager;

   @Before
   public void setup() {
	cacheManager = CacheManagerFactory.provides(CacheProvidersEnum.jcs.name(), "classpath:/cache/jcs-cache.ccf");
