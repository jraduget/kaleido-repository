...
/**
 * {@link FileStore} producer is used to extend {@link Inject} in order to use {@link Context} annotation
 * 
 * @author Jerome RADUGET
 */
public class FileStoreProducer extends FileStoreProvider {

   public FileStoreProducer() {
	super(FileStore.class);
   }

   @Produces
   public FileStore getFileStore(final InjectionPoint injectionPoint) {
