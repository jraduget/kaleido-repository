...
/**
 * {@link Cache} producer is used to extend {@link Inject} in order to use {@link Context} annotation
 * 
 * @author jraduget
 */
public class CacheProducer extends CacheProvider {
   ...
   public Cache getCache(final InjectionPoint injectionPoint) {
