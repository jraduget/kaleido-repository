...
CREATE TABLE FILESTORE (URI VARCHAR(255) NOT NULL, CONTENT BLOB(255), CREATIONDATE TIMESTAMP NOT NULL, CONTENTSIZE INTEGER, UPDATEDDATE TIMESTAMP, NAME VARCHAR(255), PATH VARCHAR(255), VERSION INTEGER, PRIMARY KEY (URI))
