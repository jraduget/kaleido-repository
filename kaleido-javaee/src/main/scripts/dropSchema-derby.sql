...
ALTER TABLE CONFIGURATION DROP CONSTRAINT CONFIGURATION0
ALTER TABLE CONFIGURATION DROP CONSTRAINT CONFIGURATION1
...
ALTER TABLE I18N_LANGUAGE DROP CONSTRAINT I18N_LANGUAGE0
