...
/**
 * Enum�ration des Implementation de MailSession Disponible
 * 
 * @author jraduget
 */
public class MailSenderEnum {
   ...
   /** Implementation Envoi Via acc�s JMS */
   ...
   /** Implementation Envoi Via acc�s EJB */
   ...
   /** Implementation Envoi Via acc�s mail Session */
