...
/**
 * Gestionnaire d'envoi de mail via �coute sur queue JMS
 * 
 * @author jraduget
 */
public class EjbMailJmsReceiver implements MessageDrivenBean, MessageListener {
   ...
   /** Nom de la propri�t� donnant le nom de l'ejb envoyant les mail */
   public final static String PropertyEjbMailSender = "ejb.mailsender.name";
   /** Nom de la propri�t� donnant le nom de la queue d'erreur eventuelle */
   public final static String PropertyQueueError = "queue.error.name";
   /** Nom de la propri�t� donnant le nom de la queue poubelle eventuelle */
   public final static String PropertyQueueBin = "queue.bin.name";
   /** Nom de la propri�t� donnant le nom de la queue factory */
   ...
   public void ejbCreate() {
	...
	// Si une configuration est trouv�
	if (config != null) {
   ...
   /**
    * Traitement des messages non d�sir�s
    * 
    * @param message
    * @param th exception eventuelle
    */
   ...
   /**
    * @return Acc�s � l'ejb qui envoie les mail
    * @param ejbMailSenderName Nom de l'ejb (acc�s local) qui envoi les mail
    * @throws Exception
    */
   ...
   /**
    * @return Nom JNDI de la queue JMS utilis�e pour les messages rejet�s
    */
   ...
   /**
    * @return Nom JNDI de la queue JMS utilis�e pour les messages poubelle
    */
