...
asadmin deploy --name=kaleido-it-ear ./kaleido-it-ear/target/kaleido-it-ear-0.9.1-SNAPSHOT.ear
asadmin deploy --name=kaleido-it-ear --dbvendorname=javadb --createtables=true  ./kaleido-it-ear/target/kaleido-it-ear-0.9.1-SNAPSHOT.ear
asadmin deploy --name=kaleido-it-ear --dbvendorname=javadb --dropandcreatetables=true  ./kaleido-it-ear/target/kaleido-it-ear-0.9.1-SNAPSHOT.ear
