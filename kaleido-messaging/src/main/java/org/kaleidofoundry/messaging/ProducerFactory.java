...
public class ProducerFactory {
   ...
   public static Producer provides(String name) {
	return PROVIDER.provides(name);
   }

   public static Producer provides(String name, RuntimeContext<?> context) {
	return PROVIDER.provides(name, context);
   }

   public static Producer provides(RuntimeContext<Producer> context) throws ProviderException {
