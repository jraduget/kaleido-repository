...
import org.kaleidofoundry.messaging.TransportProvider;

/**
 * {@link Transport} producer is used to extend {@link Inject} in order to use {@link Context} annotation
 * 
 * @author Jerome RADUGET
 */
public class TransportProducer extends TransportProvider {
   ...
   @Produces
   public Transport getTransport(final InjectionPoint injectionPoint) {
