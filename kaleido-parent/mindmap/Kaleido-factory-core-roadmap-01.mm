...
<node COLOR="#000000" CREATED="1262523247000" ID="Freemind_Link_38240127" MODIFIED="1277133298212" TEXT="Kaleido-foundry-core">
...
<node CREATED="1265977562627" ID="Freemind_Link_72346299" MODIFIED="1277065027151" TEXT="implementations">
...
<node CREATED="1274171948324" ID="ID_928887048" MODIFIED="1277065546829" STYLE="bubble" TEXT="to provide a simple and independent interface to access cache datas, local or distributed"/>
...
<node CREATED="1274171777061" ID="ID_611464567" LINK="#Freemind_Link_38802849" MODIFIED="1277133888333" STYLE="bubble" TEXT="to allow transparent use in a clustered (it uses cache stack, define your own cache policies)">
<font NAME="SansSerif" SIZE="12"/>
</node>
...
<node CREATED="1277119466972" ID="ID_1145627297" LINK="#Freemind_Link_38802849" MODIFIED="1277133408086" STYLE="bubble" TEXT="to allow transparent use in a clustered (it uses cache stack, define your own cache policies)"/>
...
<node CREATED="1277131387990" ID="ID_225512285" MODIFIED="1277133463273" STYLE="bubble" TEXT="to introduce I18nException with error code, which extends standard Exception"/>
</node>
...
<node CREATED="1274174334543" ID="ID_614757085" MODIFIED="1277132552654" POSITION="right" TEXT="runtime context injection">
...
<node CREATED="1277120070953" ID="ID_899296786" MODIFIED="1277120437607" STYLE="bubble" TEXT="to handle runtime configuration changes, and impact it to current runtime contexts"/>
...
<node COLOR="#ff0000" CREATED="1277119862938" ID="ID_1867161318" MODIFIED="1277132260812" TEXT="by default, kaleido uses aspectJ to inject classes runtime context">
<font NAME="SansSerif" SIZE="12"/>
</node>
...
<node CREATED="1277120760151" ID="ID_983704314" MODIFIED="1277129371659" STYLE="bubble" TEXT="kaleido internaly use this plugin (for resource store, cache, configuration, ...)"/>
...
<node COLOR="#338800" CREATED="1262524231000" ID="ID_360495755" MODIFIED="1277131909565" TEXT="use @Declare(&quot;plugin.impl.code&quot;) on your implementation">
<font NAME="SansSerif" SIZE="12"/>
</node>
